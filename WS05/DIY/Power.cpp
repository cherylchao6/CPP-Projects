...
Power::Power() { setEmpty(); }
Power::Power(const char *name, int rarity) { createPower(name, rarity); }
void Power::setEmpty() {
  m_name[0] = '\0';
  m_rarity = 0;
}
...
const char *Power::checkName() const { return m_name; }
int Power::checkRarity() const { return m_rarity; }
bool Power::isEmpty() const { return (m_name[0] == '\0' || m_rarity == 0); }
