...
int main() {
  ...
  LibraryItem *libraryItems[SIZE] = {
      ...
      new LibraryItem("1984", 1949), new LibraryItem("Brave New World", 1932),
  ...
  cout << endl << "Testing Copy Assignment and copy constructor" << endl;
  cout << "***********************************************" << endl;
...
void deallocate(LibraryItem *item) { delete item; }
